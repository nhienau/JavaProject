...
public class ThongKeJPanel extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        jPanel4.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(255, 102, 0), 3));

        jLabel2.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel2.setForeground(new java.awt.Color(255, 102, 0));
        jLabel2.setText("Bảng tính lợi nhuận");
        ...
        TitledBorder border1 = BorderFactory.createTitledBorder("Doang Thu");
        ...
        TitledBorder border2 = BorderFactory.createTitledBorder("Khách Hàng");
        ...
        jTable3.setModel(new javax.swing.table.DefaultTableModel(
            new Object [][] {},
            new String [] {
                "Mã SP", "Tên Sản Phẩm", "ĐV Tính", "Số Lượng"
            }
        ));
        TitledBorder border3 = BorderFactory.createTitledBorder("Sản Phẩm Bán");
        ...
        TitledBorder border4 = BorderFactory.createTitledBorder("Sản Phẩm Nhập");
        jScrollPane4.setBorder(border4);
